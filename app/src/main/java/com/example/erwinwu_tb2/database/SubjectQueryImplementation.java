...
public class SubjectQueryImplementation implements com.example.erwinwu_tb2.database.QueryContract.SubjectQuery {

    private DatabaseHelper databaseHelper = DatabaseHelper.getInstance();

    @Override
    public void createSubject(Subject subject, com.example.erwinwu_tb2.database.QueryResponse<Boolean> response) {
    ...
    @Override
    public void readAllSubject(com.example.erwinwu_tb2.database.QueryResponse<List<Subject>> response) {
    ...
    @Override
    public void updateSubject(Subject subject, com.example.erwinwu_tb2.database.QueryResponse<Boolean> response) {
        SQLiteDatabase sqLiteDatabase = databaseHelper.getWritableDatabase();
    ...
    @Override
    public void deleteSubject(int subjectId, com.example.erwinwu_tb2.database.QueryResponse<Boolean> response) {
        SQLiteDatabase sqLiteDatabase = databaseHelper.getWritableDatabase();
