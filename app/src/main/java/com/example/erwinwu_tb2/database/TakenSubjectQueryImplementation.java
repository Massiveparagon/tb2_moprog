...
import static com.example.erwinwu_tb2.util.Constants.STUDENT_ID_FK;
import static com.example.erwinwu_tb2.util.Constants.SUBJECT_CODE;
import static com.example.erwinwu_tb2.util.Constants.SUBJECT_CREDIT;
import static com.example.erwinwu_tb2.util.Constants.SUBJECT_ID;
import static com.example.erwinwu_tb2.util.Constants.SUBJECT_ID_FK;
import static com.example.erwinwu_tb2.util.Constants.SUBJECT_NAME;
...
public class TakenSubjectQueryImplementation implements com.example.erwinwu_tb2.database.QueryContract.TakenSubjectQuery {

    private DatabaseHelper databaseHelper = DatabaseHelper.getInstance();

    @Override
    public void createTakenSubject(int studentId, int subjectId, com.example.erwinwu_tb2.database.QueryResponse<Boolean> response) {
    ...
    @Override
    public void readAllTakenSubjectByStudentId(int studentId, com.example.erwinwu_tb2.database.QueryResponse<List<Subject>> response) {
    ...
    @Override
    public void readAllSubjectWithTakenStatus(int studentId, com.example.erwinwu_tb2.database.QueryResponse<List<TakenSubject>> response) {
        SQLiteDatabase sqLiteDatabase = databaseHelper.getReadableDatabase();
    ...
    @Override
    public void deleteTakenSubject(int studentId, int subjectId, com.example.erwinwu_tb2.database.QueryResponse<Boolean> response) {
        SQLiteDatabase sqLiteDatabase = databaseHelper.getWritableDatabase();
