...
import static com.example.erwinwu_tb2.util.Constants.UPDATE_STUDENT;
...
import com.example.erwinwu_tb2.features.student_crud.student_update.StudentUpdateDialogFragment;
import com.example.erwinwu_tb2.features.taken_subject_crud.taken_subject_show.StudentTakenSubjectActivity;
    ...
    public void onBindViewHolder(@NonNull StudentViewHolder holder, int position) {
        ...
        holder.editImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogFragment.show(((com.example.erwinwu_tb2.features.student_crud.student_list_show.list_murid) context).getSupportFragmentManager(), UPDATE_STUDENT);
            }
        });
